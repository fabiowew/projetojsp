												...
												<div class="card">
													...
													<div class="card-block">
														...
														<form class="form-material"	action="<%=request.getContextPath()%>/ServletUsuarioController" method="get" id="formUser">
															...
															<input id="acaoRelatorioImprimirTipo" type="hidden" name="acao" value="imprimirRelatorioUser">
																...
																<div class="form-row align-items-center">
																	...
																	<div class="col-sm-3 my-1">
																		<label class="sr-only" for="dataFinal">Data Inicial</label>
														  ...
														  <tbody>
														    <c:forEach items="${listaUser}" var="ml">
																...
																<c:forEach items="${ml.telefones}" var="fone">
																	<tr>
																		<td>
																			<td style="fonte-size: 10px"><c:out value="${fone.numero}"></c:out>
																		</td>
																	</tr>
