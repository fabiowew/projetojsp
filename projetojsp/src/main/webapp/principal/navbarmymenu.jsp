...
<nav class="pcoded-navbar">
                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          <div class="">
                              <div class="main-menu-header">
								...
								<c:if test="${imagemUser != '' && imagemUser != null}">
									    	<img alt="User-Profile_Image"  src="${imagemUser}" class="img-80 img-radius">
								</c:if>
								<c:if test="${imagemUser == '' || imagemUser == null}">  
									   	<img alt="User-Profile_Image"  src="assets/images/user.png" class="img-80 img-radius">
								</c:if>                                
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              <li>
                                  <a href="<%=request.getContextPath()%>/principal/reluser.jsp" class="waves-effect waves-dark" style="margin-top: 10px;">
